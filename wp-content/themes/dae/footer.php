 ...
 <footer id="footer">
 		...
 		<div class="container">
 			<div class="row">
 				...
 				<div class="col-lg-4 col-md-6 footer-contact">
 					...
 					<strong>WhatApp:</strong> <?php echo get_option('home_input_15'); ?><br>
 					</p>
 				</div>
 				...
 				<div class="col-lg-4 col-md-6 footer-links">
 					...
 					<ul>
 						...
 						<li><i class="bx bx-chevron-right"></i> <a href="#institucional">Institucional</a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href="#estrutura">Estrutura</a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href="#servicos">Serviços</a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href="#editais">Editais</a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href="#informativo">Informativo</a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href="#ouvidoria">Ouvidoria</a></li>
 	...
 	<div class="container py-4">
 		<div class="copyright">
 			<strong><span><?php echo get_option('home_input_1'); ?></span></strong>. Todos os direitos reservados.
 		</div>
 		<div class="credits">
 			...
 			Designed by <a target="_blank" href="https://b2s.marketing//">B2S Marketing</a>
 		</div>
 	</div>
 </footer><!-- End Footer -->
